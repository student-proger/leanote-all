...
$.extend( $.validator, {
	...
	messages: {
		...
		creditcard: "Пожалуйста, введите корректный номер банковской карты.",
		...
		rangelength: $.validator.format( "Пожалуйста, введите значение длиной между {0} и {1} символов." ),
	...
	prototype: {
		...
		customDataMessage: function( element, method ) {
			var custom_msg = $( element ).data( "msg" + method.charAt( 0 ).toUpperCase() +
		...
		optional: function( element ) {
			...
			var op = !$.validator.methods.required.call( this, val, element ) && "dependency-mismatch";
			return op;
		},
